...
#-----------------------------------------------------------------------------
vendor_saved_apps := Browser webview Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
...
#-----------------------------------------------------------------------------
board_saved_files := system/media/bootanimation.zip
